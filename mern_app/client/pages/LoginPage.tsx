      ...
      <div className="w-full max-w-md p-8 space-y-8 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl">
        <div className="text-center">
            <div className="flex justify-center mx-auto mb-4">
               <BriefcaseIcon className="h-16 w-16 text-indigo-500" />
            </div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Welcome to AttendancePro</h1>
          <p className="mt-2 text-gray-600 dark:text-gray-400">Sign in to manage your team's attendance</p>
        </div>
